use std::{fs::{self, File}, io::{self, BufReader, Read, Write, BufWriter}, result, error::Error, path::{self, PathBuf, Path}, collections::BTreeMap};
use regex::Regex;
use chrono::NaiveDate;
use pulldown_cmark::{html, Parser};

fn scan_year_dir(dates: &mut BTreeMap<NaiveDate, PathBuf>, dir: &path::Path, year: i32) -> result::Result<(), Box<dyn Error>> {
